...
```bash
git clone https://github.com/<username>/gatsby-plugin-seo
```

Next you need to install the dependencies.

```bash
cd gatsby-plugin-seo
npm install
```
...
[license]: https://github.com/bradgarropy/gatsby-plugin-seo/blob/master/license
[fork]: https://github.com/bradgarropy/gatsby-plugin-seo/fork
[contributors]: https://github.com/bradgarropy/gatsby-plugin-seo#-contributors
